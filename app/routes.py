...
def edit_file(name):
    ...
    static_data = []
    static_data.append(read_txt('app/static/D8/prefectures.txt'))
    static_data.append(read_txt('app/static/D8/avatar_gender.txt'))
    static_data.append(read_txt('app/static/D8/bgm_volume.txt'))
    static_data.append(read_txt('app/static/D8/make.txt'))
    static_data.append(read_txt('app/static/D8/car_prefectures.txt'))
    static_data.append(read_txt('app/static/D8/car_hirigana.txt'))
    static_data.append(read_txt('app/static/D8/courses.txt'))
    static_data.append(read_txt('app/static/D8/cup.txt'))
    static_data.append(read_txt('app/static/D8/tachometer.txt'))
    static_data.append(read_txt('app/static/D8/aura.txt'))
    static_data.append(read_txt('app/static/D8/class.txt'))
    static_data.append(read_txt('app/static/D8/titles.txt'))
